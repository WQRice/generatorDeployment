...
//     this.log(jpaList);
    ...
    prompting() {
        return this.prompt([{
            ...
            fs.removeSync('OutputProject');
            var packagePath = path.dirname(require.resolve("generator-CRUDStarter/package.json"));
        fs.copySync(packagePath+'/webStatic', 'OutputProject');
        var datas = parser(answers.jpaFile,answers.packageName,packagePath);
        p2j(packagePath,datas);
        p2f(packagePath,datas);
