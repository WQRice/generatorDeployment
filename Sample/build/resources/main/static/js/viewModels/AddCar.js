...
define(['ojs/ojcore', 'knockout', 'ojs/ojcheckboxset'
    ...
    function viewModel() {
        ...
        self.inputCarBrand(null);
        
        self.inputCarPrice(null);
                ...
                function (returndata) {
                    ...
                    for (var j in self.oneArray) {
                            ...
                            if (self[inputAttRef]().length > 0) {
                                ...
                                var associationUrl = "http://localhost:8080/api/Car/" + returndata.id + "/"+ self.oneArray[j]+ "/" + self[inputAttRef]()[0].id;
                        ...
                        if (self[inputAttRef]().length > 0) {
...

                            {
                                ...
                                (function (i) {
                                    ...
                                    var associationUrl = "http://localhost:8080/api/Car/" + returndata.id + "/" + self.manyArray[j] + "/" + self[inputAttRef]()[i].id;
                                   // alert(associationUrl);
                                    queuechain = queuechain.then(function () {
                                            return $.ajax({
                                                    type: "POST",
