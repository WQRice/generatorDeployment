  ...
  function(oj, ko, moduleUtils) {
     function ControllerViewModel() {
      ...
      var navData = [
              ...
              {  name: 'Student', id: 'Student', iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-home-icon-24'},
                  {  name: 'Course', id: 'Course', iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-home-icon-24'},
                  {  name: 'Professor', id: 'Professor', iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-home-icon-24'},
                  {  name: 'Office', id: 'Office', iconClass: 'oj-navigationlist-item-icon demo-icon-font-24 demo-home-icon-24'}      
