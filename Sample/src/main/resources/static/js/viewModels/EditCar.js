...
define(['ojs/ojcore', 'knockout', 'ojs/ojcheckboxset'
    ...
    function viewModel() {
        ...
        self.initialize = function () {
            ...
            self.inputCarId(rootViewModel.frontToEditData().id);



self.inputCarBrand(rootViewModel.frontToEditData().Brand);

self.inputCarPrice(rootViewModel.frontToEditData().Price);
            ...
            for (var i in self.oneArray) {
                var url = 'http://localhost:8080/Car/'+self.inputCarId()+"/"+self.attMap[self.oneArray[i]].attInSelfName;
            ...
            // for one to many relationship
                ...
                for(var j in self.manyArray) {
                    var url = 'http://localhost:8080/Car/'+self.inputCarId()+"/"+self.attMap[self.manyArray[j]].attInSelfName;
...
self.attMap = {};
        ...
        self.inputCarId = ko.observable();



self.inputCarBrand = ko.observable();

self.inputCarPrice = ko.observable();
...
// for  many array (one to many or many to many)
        ...
        elementArray.push(document.getElementById("CarBrandInput"));
        
        elementArray.push(document.getElementById("CarPriceInput"));
        ...
        self.updateRow = function () {
            ...
            $.ajax({
                ...
                url: "http://localhost:8080/Car/" + self.inputCarId(),
                data: JSON.stringify(
                    {
                        'Id': self.inputCarId(),

                        
                        'Brand' : self.inputCarBrand()
                        
                        ,
                        
                        
                        'Price' : self.inputCarPrice()
            ...
            for (var j in self.manyArray) {
                ...
                var attAssociationUrl = "http://localhost:8080/Car/" + self.inputCarId() + "/" + self.attMap[self.manyArray[j]].attInSelfName;
                        ...
                        for (var i = 0; i < oldList[self.manyArray[j]].length; i++) {
                            ...
                            if (overlap!==true) {
                                ...
                                queuechain1 = queuechain1.then(
                                    $.ajax({
                                        url: "http://localhost:8080/Car/" + self.inputCarId() + "/" + self.attMap[self.manyArray[j]].attInSelfName +"/" + oldList[self.manyArray[j]][i].id,
                                ...
                                queuechain1 = queuechain1.then(
                                    $.ajax({
                                        url: "http://localhost:8080/"+self.manyArray[j]+"/" + oldList[self.manyArray[j]][i].id + "/carIn" + self.manyArray[j]+"/" + self.inputCarId(),
                                        type: "DELETE",
                                        success: function (response) {
                                            //alert("delete success");
                        ...
                        //alert("input length many" +JSON.stringify(self[inputAttRefMany]()));
                            ...
                            for (var jj = 0; jj < self[inputAttRefMany]().length; jj++) {
                                ...
                                if (overlap != true) {
                                    ...
                                    var associationUrl = "http://localhost:8080/api/Car/" + self.inputCarId() + "/" + self.manyArray[j] + "/" + self[inputAttRefMany]()[jj].id;
            ...
            for (var j in self.oneArray) {
                ...
                if (self[inputAttRef]().length > 0) {
                    ...
                    var associationUrl = "http://localhost:8080/api/Car/" + self.inputCarId() + "/" + self.oneArray[j] + "/" + self[inputAttRef]()[0].id;
                   ...
                   // alert(associationUrl);
                    ...
                    var attAssociationUrl = "http://localhost:8080/Car/" + self.inputCarId() + "/" + self.attMap[self.oneArray[j]].attInSelfName;
                    ...
                    $.ajax({
                        ...
                        function (output) {
                           // alert(JSON.stringify(output));
                            ...
                            queuechain2 = queuechain2.then(
                                $.ajax({
                                    url: "http://localhost:8080/"+ self.oneArray[j]+"/" + output.id + "/carIn" + self.oneArray[j]+"/" + self.inputCarId(),
                                    type: "DELETE",
                                    success: function (response) {
                                      //  alert("delete success one");
                                        console.log(response);
