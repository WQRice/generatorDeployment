...
module.exports=function(packagePath,datas){
    ...
    var datasobj = {'dataArray':datas};
     ...
     fs.outputFileSync("OutputProject/src/main/resources/static/index.html", file, 'utf8');
 
     var template = fs.readFileSync(packagePath+'/frontendTemplate/appController_js_template.ejs', 'utf-8');
     var file = ejs.render ( template , datasobj );
     fs.outputFileSync("OutputProject/src/main/resources/static/js/appController.js", file, 'utf8');
    ...
    for (var i in datas) {
     ...
     fs.outputFileSync("OutputProject/src/main/resources/static/js/views/"+datas[i].CLASSNAME+".html", file, 'utf8');
   
     var template = fs.readFileSync(packagePath+'/frontendTemplate/viewModel_js_template.ejs', 'utf-8');
    var file = ejs.render ( template , datas[i] );
   fs.outputFileSync("OutputProject/src/main/resources/static/js/viewModels/"+datas[i].CLASSNAME+".js", file, 'utf8');
  }
